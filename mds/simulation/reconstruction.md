...
です。
途中の $$\epsilon$$ は十分小さな値で、[Suresh & Huynh (1997)](https://www.sciencedirect.com/science/article/abs/pii/S0021999197957454?via%3Dihub) では $$10^{-10}$$ 、その他の論文では $$10^{-20}$$ などが用いられています。
