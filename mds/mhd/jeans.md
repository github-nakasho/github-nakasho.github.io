...
今は輻射優勢期を考えているので、[光子気体の状態方程式](/cosmo/eos)より
...
と求まります。これはハッブル長と呼ばれる量です。これはハッブル時間$$1/H = a/\dot{a}$$の間に光が伝播することができる距離です。通常であれば$$\lambda_J$$より大きなスケールのゆらぎが成長しますが、光速度よりも速く情報は電πなんできないため、輻射優勢期の宇宙では$$\lambda_J$$より大きなスケールのゆらぎとはいえ、成長することができません。よって輻射優勢期は構造形成が行われないことがわかります。
