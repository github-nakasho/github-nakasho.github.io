...
1個の電子を陽子に向かって入射させた[Rutherford散乱](/ism/rutherford)から、多数の電子を入射させた場合に話を発展させることで散乱断面積という概念を学びました。次はプラズマ中ではこの散乱がどのようになるかを見てみましょう。  
...
すると運動量交換の衝突断面積は、[ラザフォード散乱の微分散乱断面積](/ism/rutherford)の式に$$(1-\cos \theta)$$の重みをかけたものを全立体角積分したものとなります。今、散乱方向は$$\theta_\mathrm{min} \leq \theta \leq \pi$$より
...
[ラザフォード散乱](/ism/rutherford)において衝突パラメータ$$b$$がちょうどデバイ長$$\lambda_D$$のとき
