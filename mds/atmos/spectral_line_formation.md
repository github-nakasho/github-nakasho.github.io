...
![](/assets/images/atmos/spectral_line_formation_03.png)

次の図の上パネルと下パネルはそれぞれ、ヒアデス星団(年齢約7億歳)とプレアデス星団(年齢約1億歳)中の主系列星の表面でのリチウム含有量を、恒星の有効温度に対して描画したものです。
まずはヒアデス星団に着目しましょう。
ここに描画されてい恒星は同じ分子雲から生まれたものなので、誕生当初は皆同じリチウム含有量を持っていたはずです。
